...
![Student dashboard](docs/screenshots/04_student_dashboard.png)
...
![Exercise page](docs/screenshots/05_student_exercise.png)
...
![Teacher sign-up](docs/screenshots/03_register_teacher.png)
...
![Teacher dashboard](docs/screenshots/07_teacher_dashboard.png)
...
![Student detail](docs/screenshots/09_teacher_student_detail.png)
...
![Exercise library](docs/screenshots/08_teacher_exercises.png)
...
![Student sign-up](docs/screenshots/02_register_student.png)
...
│       ├── routers/
│       │   ├── auth.py          Login, register (student & teacher), consent
│       │   ├── tutor.py         Chat, hints, task decomposition
│       │   ├── exercises.py     Listing, running, testing, progress
│       │   ├── progress.py      Per-student progress + session tracking
│       │   ├── teacher.py       Classroom overview, student detail, trends
...
obvious without needing subtext. The repo still lives in a directory called
